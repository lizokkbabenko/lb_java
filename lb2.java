...
public class lb2 {
    public static class Task1 {
        ...
        public static void main(String[] args) {
            ...
            System.out.print("Enter the value for l: ");
            ...
            for (int kCounter = 1; kCounter <= 30; ++kCounter) {
                sum += calculateFunction(m, l, i, kCounter);
            }

            System.out.println("Result: " + sum);
        }

        private static double calculateFunction(double m, double l, double i, int k) {
            return Math.sqrt(m * (l / i)) * Math.sin(m * i) + Math.tan(k / i);
        }
    }
